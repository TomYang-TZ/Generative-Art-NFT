...
def generate_prompt():
    ...
    positive_prompt_pool = {
        "technology": [
            ...
            "Starry Navigation System", "Orion's Belt Energy Harvester", "Pleiades Communication Network",
            "Andromeda Data Archive"
        ],
        "lighting": [
            ...
            "Constellation Illumination Pattern", "Zodiacal Light Display", "Ursa Major Energy Emission",
            "Sirius Starlight Effect"
        ],
        "viewpoint": [
            ...
            "Observing from a Constellation", "Milky Way Edge Perspective", "Through the Lens of Cassiopeia",
            "View from the Star Cluster"
        ],
        "colorScheme": [
            ...
            "Celestial Constellation Hues", "Orion Nebula Color Palette", "Galactic Cluster Spectrum",
            "Andromedan Sky Tones"
        ],
        "SciFiObject": [
            ...
            "Celestial Star Mapper", "Galaxy Pattern Decoder", "Constellation Energy Converter",
            "Orbiting Star Observatory"
        ],
        "SciFiEnvironment": [
        ...
        "SciFiTechnology": [
            ...
            "Stellar Constellation Analyzer", "Galactic Coordinate System", "Orion's Belt Locator",
            "Celestial Sphere Projector"
        ],
        "LightingAndEffects": [
            ...
            "Constellation Glow Effect", "Starry Sky Ambient Lighting", "Galactic Core Constellation Reflection",
            "Pulsar Light Pattern"
        ],
        "CharacterAndDesign": [
            ...
            "Celestial Guardian", "Stellar Mage", "Quantum Entity", "Galactic Diplomat", "Time Traveler",
            "Alien Mystic",
    ...
    negative_prompt_pool = {
        ...
        "AvoidArtStyles": [
            ...
            "Non-Realistic Depictions of Space", "Overly Abstract Constellations",
            "Unscientific Stellar Representations"
        ],
        "AvoidScenes": [
    ...
    for trait, values in positive_prompt_pool.items():
        ...
        if positive_prompt:
            ...
            positive_prompt = values[rno1] + ', ' + values[rno2] + ', ' + values[rno3]
        positive_attributes.append(
            {"trait_type": trait, "value": values[rno1] + ', ' + values[rno2] + ', ' + values[rno3]})
...
if __name__ == "__main__":
    ...
    mcs_img_link, chainlink_function_contract_address, nft_contract_address, dataset_address, license_mint_hash = generateArtNFT(
        POS_TEXT_PROMPT=POS_TEXT_PROMPT, NEG_TEXT_PROMPT=NEG_TEXT_PROMPT)
    print("Final Result:")
    print("--------------------")
